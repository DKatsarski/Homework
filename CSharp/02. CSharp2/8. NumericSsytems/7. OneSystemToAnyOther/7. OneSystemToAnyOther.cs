...
namespace _7.OneSystemToAnyOther
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            BigInteger firstNumSys = BigInteger.Parse(Console.ReadLine());
            string numberFirstNumSys = Console.ReadLine();
            BigInteger secondNumSys = BigInteger.Parse(Console.ReadLine());

            BigInteger result = BaseToDecimal(numberFirstNumSys, firstNumSys);
            string realResult = DecmimalToBase(result, secondNumSys);
